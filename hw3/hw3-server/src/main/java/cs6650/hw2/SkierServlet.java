...
public class SkierServlet extends HttpServlet {
    private final static String QUEUE_NAME_SKIER = "skierQueue";
    private final static String QUEUE_NAME_RESORT = "resortQueue";
        ...
        if (!isUrlValidPost(s)) {
           ...
           try {
               ...
               System.out.println("creating and borrowing channel");
                JSONObjUtil.sendMessageToQueue(skierObj, QUEUE_NAME_SKIER, channel);
                JSONObjUtil.sendMessageToQueue(skierObj, QUEUE_NAME_RESORT, channel);
           } catch (IOException e) {
